...
def test_add_metadata(sample_dir):
    ...
    assert ts_map.images["parent"][image_ID]["coord"] == approx((-4.21875, -3.60352, 55.80128, 56.05977), rel=1e-3)
...
def test_addGeoInfo(sample_dir):
    ...
    assert geotiff.images["parent"][image_ID]["coord"] == approx((-0.06471, -0.04852, 51.60808, 51.61590), rel=1e-3)
