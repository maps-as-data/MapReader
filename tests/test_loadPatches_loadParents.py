...
def create_test_dir():
    ...
    if not os.path.exists(parent_dir_name):
        ...
        if not os.path.exists(f"{parent_dir_name}/{patch_dir_name}"):
            ...
            files=['patch1-0-1-2-3-#file1.png#.png', 'patch2-4-5-6-7-#file1.png#.png', 'patch1-0-1-2-3-#file2.png#.png']
            for file in files:
...
def test_load_patches_w_parent_dir_w_file_ext(create_test_dir):
    my_files=load_patches("test_parent_dir/patch_dir", parent_paths="test_parent_dir", parent_file_ext="png")
...
def test_load_patches_w_parent_file_paths(create_test_dir):
    my_files=load_patches("test_parent_dir/patch_dir", parent_paths="test_parent_dir/*png")
    assert len(my_files)==6
