...
def test_versus_loader(sample_dir):
    ...
    assert geotiff.parents["cropped_geo.tif"]["coordinates"] == approx(reprojected_coords)
    loader_size_in_m, _, _ = geotiff._calc_pixel_height_width("cropped_geo.tif", method = "great-circle",)
