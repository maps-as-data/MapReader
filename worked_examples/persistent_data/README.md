...
We have provided some metadata files in `mapreader/worked_examples/persistent_data`. For all these file, please note the re-use terms:
...
# Copyright and re-use terms of the digitized maps
