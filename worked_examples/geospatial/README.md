...
| workshop_june_2023 | Patch Classification | Historical Maps | TBC | Classify patches from OS maps | MapReader patch outputs | [add annotations] | [add model link] | (no paper) | Rosie Wood, Katie McDonough |
