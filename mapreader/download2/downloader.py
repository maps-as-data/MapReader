...
class Downloader:
    ...
    def download_map_by_polygon(self, polygon: Polygon, download_url: Union[str, list], zoom_level: int = 14, path_save: str = "./maps/") -> None:
        """
        Note
        -----
        ...
        assert isinstance(polygon, Polygon), "[ERROR] \
