...
.. py:class:: mapImages(path_images = None, tree_level = 'parent', parent_path = None, **kwds)
   ...
   **kwds : dict, optional
   ...
   .. py:method:: add_shape(tree_level = 'parent')
      ...
      Notes
      -----
      The method runs :meth:`mapreader.load.images.mapImages.add_shape_id`
   ...
   .. py:method:: add_coord_increments()
      ...
      -----
      The method runs
      :meth:`mapreader.load.images.mapImages.add_coord_increments_id`
   ...
   .. py:method:: add_center_coord(tree_level = 'patch')
      ...
      -----
      The method runs
      :meth:`mapreader.load.images.mapImages.add_center_coord_id`
   ...
   .. py:method:: add_coord_increments_id(image_id, verbose = False)
      ...
      :meth:`mapreader.load.images.mapImages.add_shape_id` method to add
      it.


   .. py:method:: add_center_coord_id(image_id, tree_level = 'patch', verbose = False)
   ...
   .. py:method:: patchifyAll(method = 'pixel', patch_size = 100, path_save = 'patches', square_cuts = False, resize_factor = False, output_format = 'png', rewrite = False, verbose = False, tree_level = 'parent', add_to_parent = True, id1 = 0, id2 = -1)
